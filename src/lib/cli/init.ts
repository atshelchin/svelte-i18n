...
${namespace !== 'app' ? `import { getI18nInstance } from '@shelchin/svelte-i18n';
import type { I18nInstance } from '@shelchin/svelte-i18n';` : ''}
import type { ${typePrefix} } from '${typeImportPath.replace('.d.ts', '')}';
...
${namespace !== 'app' ? `// Get package name
...
${namespace !== 'app' ? `// Auto-initialize the library i18n when in browser
