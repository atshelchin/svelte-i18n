...
export interface I18nKeys {
	...
	items: {
		count: ParamsKey<{ count: string | number }>;
		empty: string;
		loading: string;
	};
	actions: {
	...
	demo: {
		title: string;
		features: string;
		interpolation: ParamsKey<{ name: string | number }>;
		pluralization: string;
		nested: string;
		formatting: string;
		switchLanguage: string;
		currentLocale: ParamsKey<{ locale: string | number }>;
		tryIt: string;
		...
		validationErrors: ParamsKey<{ count: string | number }>;
		showFormattingExamples: string;
		hideFormattingExamples: string;
		dateFormats: ParamsKey<{ locale: string | number }>;
		timeFormats: string;
		...
		standard: string;
		decimal: string;
		compact: ParamsKey<{ number: string | number }>;
		percent: string;
		relativeTime: string;
		list: string;
		coreFeatures: string;
	...
	editor: {
		...
		removeSource: string;
		addSource: string;
		sourcesLoaded: ParamsKey<{ count: string | number }>;
		progress: string;
		translated: string;
		...
		confirmTranslateAll: ParamsKey<{ count: string | number }>;
		translateSuccess: string;
		translateFailed: string;
		errors: {
			invalidUrl: string;
			maxSources: string;
			loadFailed: ParamsKey<{ error: string | number }>;
			jsonOnly: string;
			parseFailed: string;
			aiConfig: string;
			noSource: string;
